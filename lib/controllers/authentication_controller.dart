...
class AuthenticationController extends GetxController {
  ...
  void loadRemember(TextEditingController phoneController,
  ...
  Future<void> signInHandler(TextEditingController phoneController,
    ...
    if (phoneController.text.isEmpty) {
      ...
      _onLoading(context, jsonEncode(dataAuthentication), phoneController.text,
          passwordController.text);
    }
  }

  Future<void> _onLoading(BuildContext context, Object body, String userName,
    ...
    dynamic value =
        await Networking.getInstance().getMetadata(userName, password);
    if (value == 401) {
